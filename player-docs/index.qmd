...
sequenceDiagram
    ...
    loop
        ...
        opt
            MH->>VM:vopPageNavigationCommand
        end
        opt
            VM->>MH:vopUnitNavigationRequestedNotification
        end
        opt
            MH->>VM:vopNavigationDeniedNotification
        end
        opt
            VM->>MH:vopWindowFocusChangedNotification
        end
    end
```
