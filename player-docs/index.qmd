...
format:
    html:
        other-links:
            - text: Spezifikation Player
              href: https://verona-interfaces.github.io/player/
---
...
Die Spezifikation der API finden Sie [hier](https://verona-interfaces.github.io/player/).
...
Es wird ein [Widget](../widget-docs/index.qmd) angefordert.
...
* `widgetType`: Hier ist der Typ des Widgets anzugeben: `WIDGET_CALC` für einen virtuellen Taschenrechner, `WIDGET_PERIODIC_TABLE` für ein Periodensystem der Elemente, `WIDGET_MOLECULE_EDITOR` für einen Molekül-Editor.[^1]
