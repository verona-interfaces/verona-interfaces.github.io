...
[//]: # "Ich würde das Wort 'Modul' exklusiv für das Verona-Modul nutzen, um Verwechslungen beim schnellen überfliegen des Textes zu vermeiden. Statt von 'Modul-Host' lieber von 'Host-Anwendung' sprechen"
```{mermaid}
sequenceDiagram
