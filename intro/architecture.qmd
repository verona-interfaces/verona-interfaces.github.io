...
[//]: # "der Player farblich hervorheben, sonst lässt sich schwer erkennen, worauf der Fokus liegt"
```{mermaid}
flowchart BT
...
* Dem Modul werden Daten übergeben, die dann das Verhalten, die Erscheinung usw. beeinflussen. Ein Player z. B. bekommt die sog. Unit-Definition, ein Schemer des Unit-Kodierschema. Diese Daten dürfen selbst keinen Code enthalten.
