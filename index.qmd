...
| ------ | ---------------- | :-----: | :-------: | :---- |
| **Player** | Komponente, die eine Aufgabe in einer Testanwendung abspielt | [{{< fa file-invoice size=2x >}}](https://verona-interfaces.github.io/player/) | [{{< fa brands github size=2x >}}](https://github.com/verona-interfaces/player#readme) | 5.2.0 |
| **Editor** | Komponente, mit der man Aufgaben gestaltet |  [{{< fa file-invoice size=2x >}}](https://verona-interfaces.github.io/editor/) | [{{< fa brands github size=2x >}}](https://github.com/verona-interfaces/editor#readme) | 4.2.0 |
| **Schemer** | Komponente, mit der man die Kodieranweisungen für die Antwortverarbeitung festlegt | [{{< fa file-invoice size=2x >}}](https://verona-interfaces.github.io/schemer/) | [{{< fa brands github size=2x >}}](https://github.com/verona-interfaces/schemer#readme) | 2.0.0 |
