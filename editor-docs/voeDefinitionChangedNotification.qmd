...
Nachfolgend sind die Parameter des Payloads für die Nachricht `voeDefinitionChangedNotification` erläutert. Für einen Gesamtblick auf die Kommunikation des Player-Moduls mit dem Host siehe [hier](index.qmd).
